...
namespace DarkUI.Controls
{
    public class DarkSectionPanel : Panel
    {
		...
		public bool AlwaysBlue
		{
			get { return _alwaysBlue; }
			set
			{
				_alwaysBlue = value;
				Invalidate();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Draw header
			var bgColor = (ContainsFocus || _alwaysBlue) ? Colors.BlueBackground : Colors.HeaderBackground;
			var darkColor = (ContainsFocus || _alwaysBlue) ? Colors.DarkBlueBorder : Colors.DarkBorder;
            var lightColor = (ContainsFocus || _alwaysBlue) ? Colors.LightBlueBorder : Colors.LightBorder;
